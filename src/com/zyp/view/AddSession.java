...
public class AddSession extends JInternalFrame {
	...
	public AddSession() {
		...
		lblNewLabel_3.setFont(new Font("楷体", Font.BOLD | Font.ITALIC, 20));
		...
		lblNewLabel_5.setFont(new Font("楷体", Font.BOLD | Font.ITALIC, 20));
		...
		btnNewButton.setFont(new Font("楷体", Font.BOLD | Font.ITALIC, 20));
		
		JLabel lblNewLabel_6 = new JLabel("电影院");
		lblNewLabel_6.setFont(new Font("楷体", Font.BOLD, 26));
		
		JLabel lblNewLabel_7 = new JLabel("场厅");
		lblNewLabel_7.setFont(new Font("楷体", Font.BOLD, 24));
		
		JLabel lblNewLabel_8 = new JLabel("场次");
		lblNewLabel_8.setFont(new Font("楷体", Font.BOLD, 23));
