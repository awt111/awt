...
public class AddMovie extends JInternalFrame {
	...
	public AddMovie() {
		...
		movieNameLabel.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		...
		movielanglabel.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		...
		movieLoaLabel.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		...
		picaddressLabel.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		...
		timeLabel.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		...
		movietypeLabel.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		 movietypeBox = new JComboBox();
		 movietypeBox.setFont(new Font("方正兰亭超细黑简体", Font.PLAIN, 20));
		...
		scoreLabel.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		...
		JLabel label = new JLabel("简介：");
		label.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
										...
										.addComponent(movielangText, GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE))
									.addGap(63)
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
									...
									.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
										...
										.addComponent(movieLoaText, GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)))
								.addGroup(groupLayout.createSequentialGroup()
									.addGap(21)
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(82)
							.addComponent(detailtextArea, GroupLayout.PREFERRED_SIZE, 119, GroupLayout.PREFERRED_SIZE)
							.addGap(125)
							.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
