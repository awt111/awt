...
public class MovieManage extends JInternalFrame {
	 ...
	 */
	public MovieManage() {
		getContentPane().setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		JScrollPane scrollPane = new JScrollPane();
		
		JLabel lblNewLabel = new JLabel("编号:");
		lblNewLabel.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		mIdText = new JTextField();
		mIdText.setEditable(false);
		mIdText.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		mIdText.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("电影名字:");
		lblNewLabel_1.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		movieNameText = new JTextField();
		movieNameText.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		movieNameText.setColumns(10);
		
		JLabel lblNewLabel_2 = new JLabel("语言:");
		lblNewLabel_2.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		movielangText = new JTextField();
		movielangText.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		movielangText.setColumns(10);
		
		JLabel lblNewLabel_3 = new JLabel("地区:");
		lblNewLabel_3.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		mlocaText = new JTextField();
		mlocaText.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		mlocaText.setColumns(10);
		
		JLabel lblNewLabel_4 = new JLabel("类别:");
		lblNewLabel_4.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		movieTypeText = new JTextField();
		movieTypeText.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		movieTypeText.setColumns(10);
		
		JLabel lblNewLabel_5 = new JLabel("海报地址:");
		lblNewLabel_5.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		moviepicadreText = new JTextField();
		moviepicadreText.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		moviepicadreText.setColumns(10);
		
		 txtrDetailtest = new JTextArea();
		txtrDetailtest.setText("detailTest");
		txtrDetailtest.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		...
		btnNewButton.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		...
		btnNewButton_1.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		JLabel lblNewLabel_6 = new JLabel("类型:");
		lblNewLabel_6.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		JLabel lblNewLabel_7 = new JLabel("电影名:");
		lblNewLabel_7.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		serNameText = new JTextField();
		serNameText.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		...
		serbtn.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		 movieDeText = new JTextArea();
		 movieDeText.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		 movieDeText.setLineWrap(true);
		
		JLabel lblNewLabel_8 = new JLabel("时长:");
		lblNewLabel_8.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		timeText = new JTextField();
		timeText.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		timeText.setColumns(10);
		
		JLabel lblNewLabel_9 = new JLabel("评分:");
		lblNewLabel_9.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		
		scoreText = new JTextField();
		scoreText.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		scoreText.setColumns(10);
		
		 serTypecomboBox = new JComboBox();
		serTypecomboBox.setFont(new Font("方正兰亭超细黑简体", Font.BOLD | Font.ITALIC, 20));
		serTypecomboBox.addItem("科幻");
		serTypecomboBox.addItem("动作");
		serTypecomboBox.addItem("爱情");
		serTypecomboBox.addItem("剧情");
		serTypecomboBox.addItem("动画");
